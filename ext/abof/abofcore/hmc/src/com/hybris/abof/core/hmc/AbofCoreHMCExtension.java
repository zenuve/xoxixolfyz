 ...
 *
 */
package com.hybris.abof.core.hmc;
...
/**
 * Provides necessary meta information about the abofcore hmc extension.
 * 
 * 
 * @version ExtGen v4.1
 */
public class AbofCoreHMCExtension extends HMCExtension
{
	/** Edit the local|project.properties to change logging behavior (properties log4j.*). */
	@SuppressWarnings("unused")
	private static final Logger LOG = Logger.getLogger(AbofCoreHMCExtension.class.getName());

	/** Path to the resource bundles. */
	public static final String RESOURCE_PATH = "com.hybris.abof.core.hmc.locales";

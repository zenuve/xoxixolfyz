 ...
 *
 */
package com.hybris.abof.cockpits.setup;
...
import com.hybris.abof.cockpits.constants.AbofCockpitsConstants;
 ...
 */
@SystemSetup(extension = AbofCockpitsConstants.EXTENSIONNAME)
public class CockpitSystemSetup extends AbstractSystemSetup
{
	...
	public void createEssentialData(final SystemSetupContext context)
	{
		...
		{
			if (MediaManager.getInstance().getMediaFolderByQualifier(AbofCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER).size() < 1)
			{
				MediaManager.getInstance().createMediaFolder(AbofCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER,
						AbofCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER);
			}
			try
			{
				String prefix = null;
				...
				if (prefix != null){
					importImpexFile(context, "/abofcockpits/reportcockpit/import/" + prefix + "_jasperreports.impex");
				}
			}

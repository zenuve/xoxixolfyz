 ...
 *
 */
package com.hybris.abof.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception //NOPMD
	{
		...
		warehouseCounter.setName(AbofFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(AbofFulfilmentProcessConstants.PARENT_PROCESS);

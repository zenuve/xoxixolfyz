 ...
 *
 */
package com.hybris.abof.fulfilmentprocess.test.jobs;
...
import com.hybris.abof.fulfilmentprocess.jobs.CleanUpFraudOrderJob;
...
public class CleanUpFraudOrderJobTest extends ServicelayerTransactionalTest
{
	...
	private static final String PROCESS_DEFINITION_NAME = AbofFulfilmentProcessConstants.ORDER_PROCESS_NAME;

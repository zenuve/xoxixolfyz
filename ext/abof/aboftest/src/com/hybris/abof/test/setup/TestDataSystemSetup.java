 ...
 *
 */
package com.hybris.abof.test.setup;
...
import com.hybris.abof.test.constants.AbofTestConstants;
import com.hybris.abof.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = AbofTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/aboftest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/aboftest/import/reviews.impex");
			...
			importImpexFile(context, "/aboftest/import/cstickets.impex");
		}
	}
}
